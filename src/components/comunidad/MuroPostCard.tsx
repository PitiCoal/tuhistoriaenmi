...
import { MURO_EMOJIS, renderContentWithBold, getCategoryLabel, CATEGORY_STYLES } from '@/lib/muro-utils'
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {categoryLabel && (
              <span className={`text-[9px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full ${CATEGORY_STYLES[post.category || ''] || 'bg-green-50 text-green-600 border border-green-100'}`}>
                {categoryLabel}
              </span>
            )}
          </div>
