export default function PlatformShowcase() {
  return (
    <div className="bg-card rounded-xl md:rounded-2xl p-4 md:p-6 border border-gray-200/70 shadow-md space-y-3 md:space-y-4">
      <p className="text-center text-xs md:text-sm font-medium text-text-light">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-3">
        <a href="https://youtube.com/@tuHistoria-EnMi" target="_blank" rel="noopener noreferrer"
          className="flex items-center gap-2 px-2.5 md:px-4 py-2 md:py-3 rounded-xl bg-yt text-white text-xs md:text-sm font-semibold hover:bg-yt/90 transition-colors shadow-sm">
        ...
        <a href="https://open.spotify.com/show/5BVlJIWDq8hEBvluzLs5DO" target="_blank" rel="noopener noreferrer"
          className="flex items-center gap-2 px-2.5 md:px-4 py-2 md:py-3 rounded-xl bg-spotify text-white text-xs md:text-sm font-semibold hover:bg-spotify/90 transition-colors shadow-sm">
          <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 md:w-5 md:h-5 shrink-0">
        ...
        <a href="https://podcasts.apple.com/cl/podcast/tu-historia-en-mi/id6785640275" target="_blank" rel="noopener noreferrer"
          className="flex items-center gap-2 px-2.5 md:px-4 py-2 md:py-3 rounded-xl bg-apple text-white text-xs md:text-sm font-semibold hover:bg-apple/90 transition-colors shadow-sm">
          <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 md:w-5 md:h-5 shrink-0">
        ...
        <a href="https://music.amazon.com/podcasts/cb65284d-587e-40dc-800f-736c4a89adc0/tu-historia-en-mi" target="_blank" rel="noopener noreferrer"
          className="flex items-center gap-2 px-2.5 md:px-4 py-2 md:py-3 rounded-xl bg-amazon text-white text-xs md:text-sm font-semibold hover:bg-amazon/90 transition-colors shadow-sm">
          <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 md:w-5 md:h-5 shrink-0">
