...
const FALLBACK: Record<string, string> = {
  ...
  como_empezo: 'Tu Historia En Mí nace de una búsqueda profunda de encuentro humano y espiritual, y del deseo de compartir testimonios de fe que nos unan y nos permitan resignificar la fe en la vida diaria. Surge de la convicción del impacto que genera escuchar un testimonio real: ver cómo Dios le habla a alguien en su cotidianidad, descubrir el paso de Dios por nuestras vidas y atreverse a compartir la propia historia.\n\nEl proyecto comenzó como un podcast de testimonios donde se comparte cómo pasa la mano de Dios por nuestras vidas, el cual sigue siendo nuestro pilar central y canal de evangelización principal. Además, busca resignificar la fe, vivirla y compartirla, creciendo como un espacio integral de encuentro y contención comunitaria.',
  que_buscamos: 'Ser un puente que conecte a las personas con Dios a través de historias reales de fe y vida. Buscamos que más personas conozcan a Dios, se acerquen a Él y descubran que en sus dificultades y desafíos de la vida nunca están solos. Cada testimonio compartido es una semilla de fe sembrada en quien lo escucha.',
  ...
  creadora_bio: 'Convencida de que cada historia tiene un propósito y que al compartirla, alguien encuentra luz en la suya. Este proyecto nace del deseo de crear un espacio donde poder hablar de fe, resignificarla y compartirla cada día.',
